...
print("\nBuilding Offline Dataset (no scaling)...")
topics = [
...
output_file = "aligned_dataset_shapes_no_scaling.txt"
...
ds_cfg.scale_lin_vel = False
ds_cfg.scale_ang_vel = False
ds_cfg.scale_commands = False
ds_cfg.scale_joint_pos = False
ds_cfg.scale_joint_vel = False
ds_cfg.scale_actions = False


dataset, episode_sums_total = build_offline_dataset(aligned, ds_cfg)
save_offline_dataset_hdf5(dataset, filename="offline_dataset_no_scaling.hdf5")
...
with open(output_file, "a") as f:
    ...
    for term_name, term_total in sorted(episode_sums_total.items()):
        term_total_adjusted = term_total
